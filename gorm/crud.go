...
func main() {
	...
	dsn = "test:1234@tcp(127.0.0.1:3306)/mysql?charset=utf8mb4&parseTime=True&loc=Local"
	// 高级配置
	config := mysql.Config{
		//DSN:                       "root:1231@tcp(127.0.0.1:3306)/test?charset=utf8mb4&parseTime=True&loc=Local", // DSN data source name
		DSN:                       dsn,
